 ...
 */
class GetPanelsTask(private val mStreamerName: String?) : Callable<MutableList<Panel>> {
    override fun call(): MutableList<Panel> {
        val result: MutableList<Panel> = ArrayList()
