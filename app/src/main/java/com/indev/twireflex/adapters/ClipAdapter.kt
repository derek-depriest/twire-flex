package com.indev.twireflex.adapters
...
import com.indev.twireflex.activities.stream.ClipActivity
import com.indev.twireflex.activities.stream.ClipActivity.Companion.createClipIntent
import com.indev.twireflex.adapters.MainActivityAdapter.ElementsViewHolder
...
class ClipViewHolder(v: View) : ElementsViewHolder(v) {
    ...
    override val targetsKey: CharSequence
        get() =
            vDisplayName.text.toString() + vTimeStamp.text.toString()
...
class ClipAdapter(recyclerView: AutoSpanRecyclerView, private val activity: Activity) :
    ...
    private fun getFormattedLengthAndTime(clip: Clip): String {
        ...
        return "$time - ${DateUtils.formatElapsedTime(clip.duration.roundToLong())}"
    }
